...
/// The Evidence resource describes the conditional state (population and any exposures being compared within the population) and outcome (if specified) that the knowledge (evidence, assertion, recomme...
...
pub struct Evidence {
    ...
    pub exposure_background: Box<Reference>,

    /// What exposure?
    #[serde(rename = "exposureVariant")]
    pub exposure_variant: Option<Vec<Box<Reference>>>,
