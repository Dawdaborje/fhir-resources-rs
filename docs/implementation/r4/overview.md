# FHIR R4 Code Generator - Overview

## Purpose

The FHIR R4 code generator transforms FHIR JSON schema definitions into type-safe Rust structures. This enables compile-time validation of FHIR resources and provides idiomatic Rust APIs for healthcare data interchange.
...
5. **Scalability** - Design supports future FHIR versions (R4B, R5, R6) with minimal changes
